...
* cd proj dir
* go to each service folder ex:cd product_servies and run --> npm i
* npm install pm2@latest -g
* pm2 start ./each_sevices/main.js(go to each service base folder and select main.js)
* For kafka tar -xvf kafka_2.12-3.6.1.tgz and cd kafka_2.12-3.6.1
* ./bin/zookeeper-server-start.sh config/zookeeper.properties
* ./bin/kafka-server-start.sh config/server.properties
* ./bin/kafka-topics.sh --create --topic ecommerce --bootstrap-server localhost:9092
